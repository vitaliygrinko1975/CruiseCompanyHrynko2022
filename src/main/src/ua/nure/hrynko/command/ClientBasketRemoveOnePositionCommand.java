 ...
 * Lists cruises items.
 */
public class ClientBasketRemoveOnePositionCommand extends Command {
    private static final long serialVersionUID = 7732286214029478505L;
    private static final Logger LOG = Logger.getLogger(ClientBasketRemoveOnePositionCommand.class);
    private final transient MySqlCruiseDAO cruiseDAO;


    public ClientBasketRemoveOnePositionCommand(MySqlCruiseDAO cruiseDAO) {
